      ...
      <BrowserRouter>
        ...
        <React.Suspense fallback={loading()}>
          <Switch>
            ...
            <Route exact path={process.env.PUBLIC_URL + "/forgot-password"} name="Forgot Password Page" render={props => <ForgotPassword {...props} />} />
            <Route exact path={process.env.PUBLIC_URL + "/reset-password/:resettoken"} name="Reset Password" render={props => <ResetPassword {...props} />} />
